var mleadsnew = 'cT5wMjRIsbDJogrk1cAACB0Ia3bh3QxG';var cartinfo = {"country":"UA","prices":{"3487":{"AE":{"price":"189.00","percent":"100","dostavka":"20","old_price":"378.00","geo_code":"AE","geo_name":"\u0410\u0440\u0430\u0431\u0441\u043a\u0438\u0435 \u042d\u043c\u0438\u0440\u0430\u0442\u044b","currency":"AED","currency_code":"AED","description":"","name":"Monocular - UAE"},"BH":{"price":"18.00","percent":"100","dostavka":"2","old_price":"36.00","geo_code":"BH","geo_name":"\u0411\u0430\u0445\u0440\u0435\u0439\u043d","currency":".\u062f.\u0628","currency_code":"BHD","description":"","name":"Monocular - UAE"}}},"tel":[]};var footertext = 'ООО «Мл-Стайл» ИНН 7723445460<br>ОГРН 1167746439321<br>г. Москва, ул. Кожуховская 5-я, д. 12<br/><a onclick="javascript: cartPolitika();" style="cursor: pointer;">\u041F\u043E\u043B\u0438\u0442\u0438\u043A\u0430 \u043A\u043E\u043D\u0444\u0438\u0434\u0435\u043D\u0446\u0438\u0430\u043B\u044C\u043D\u043E\u0441\u0442\u0438 </a><br/><a href="http://monsterleads.pro/?utm_source=from_land" target="_blank">MonsterLeads.Pro</a>';function cartFrameInit(params) {
    console.log("init");
    ...
    ;
    iframe.src = 'http://c.cpam.pro/' + landing_id + '/frame?mleads=cT5wMjRIsbDJogrk1cAACB0Ia3bh3QxG&t=' + parseInt(cartStartTime || 0) + '&product_id=' + product_id + (type !== '' ? '&type=' + type : '') + (params.subtype === 'fast_call' ? '&subtype=fast_call' : '') + (params.tel ? '&tel=' + encodeURIComponent(params.tel) : '');
...
function cartPolitika() {
    ...
    cartIframe('http://proml.net/politika.html');
...
}function sendBaseEvent(event) {var http = new XMLHttpRequest();var url = "http://c.cpam.pro/11451/cross_query?&code=&geo_id=2&subid_id=&subid2_id=&subid3_id=&subid4_id=&subid5_id=&event_trigger=true&unique=1&event=" + event;var params = "";http.open("POST", url, true);http.onreadystatechange = function(){if (http.readyState == 4) {}};http.setRequestHeader("Content-type", "application/x-www-form-urlencoded");http.send(params);};try { (function (d, w, c) { (w[c] = w[c] || []).push(function() { try { w.yaCounter25634507 = new Ya.Metrika({id:25634507, clickmap:true, webvisor: true, accurateTrackBounce:true, ut:"noindex"});  } catch(e) { } }); var n = d.getElementsByTagName("script")[0], s = d.createElement("script"), f = function () { n.parentNode.insertBefore(s, n); }; s.type = "text/javascript"; s.async = true; s.src = (d.location.protocol == "https:" ? "https:" : "http:") + "//d31j93rd8oukbv.cloudfront.net/metrika/watch_ua.js"; if (w.opera == "[object Opera]") { d.addEventListener("DOMContentLoaded", f, false); } else { f(); } })(document, window, "yandex_metrika_callbacks"); } catch(e) {console.log("problem w y.metrika"+e.message); };